...
# Needs updated because I manually ran them and added the results
# But I updated the code so only a single shuffle of the deck occurs, changing the results of these games